...
class generar_fichapersonal {
	...
	function __construct()
	{
		...
		$this->opcion = "Declaracion firma electronica ";
		$this->opciondetalle = "";
		$this->opcionicono = "fa fa-cog";
		$this->opcionnivel1 = "FORMULARIO";
		$this->opcionnivel2 = "<li>Declaracion firma electronica</li>";
    ...
    private function acceder()
    {
        ...
        //$this->pagina->agregarDato("EMPRESA_Rut", $dt->data[0]['RutEmpresa']);
		...
		$dat["opcionid"] = 'DeclaracionConflictoInteresEmail.php';
		...
		$this->pagina->imprimirTemplate('templates/DeclaracionConflictoInteresEmail.html');
	}
