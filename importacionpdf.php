...
$page = new importacionpdf();


class importacionpdf {
	...
	{	
		...
		$this->pagina->imprimirTemplate('templates/importacionpdf_FormularioAgregar.html');
	}
	...
	private function verdocumento($idDocumento)
	{
		...
		$formulario[0]["idDocumento"] = $idDocumento;
		...
		$this->pagina->imprimirTemplate('templates/importacionpdf_documento.html');				
	}
