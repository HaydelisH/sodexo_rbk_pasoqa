...
include_once("includes/docmanualesBD.php");
...
class docmanuales{
	...
	function __construct()
	{
		...
		$this->docmanualesBD = new docmanualesBD();
		...
		$this->docmanualesBD->usarConexion($conecc);
	...
	{	
		...
		$this->mensajeError.=$this->docmanualesBD->mensajeError;
		$formulario[0]["formulario"]=$dt->data;		
		$this->pagina->agregarDato("formulario",$formulario);
		...
		$this->pagina->imprimirTemplate('templates/documentos_manuales_Documento.html');
	...
	{  
       ...
       // print_r($_POST);
		...
		$this->docmanualesBD->total($datos,$dt);
		...
		$this->docmanualesBD->listado($datos,$dt);
		$this->mensajeError.=$this->docmanualesBD->mensajeError;
		...
		$this->pagina->agregarDato("formulario",$formulario);
         ...
         //print_r($datos["pagina_ultimo"]);
		//$this->pagina->agregarDato("formulario",$formulario);
		$this->pagina->agregarDato("mensajeError",$this->mensajeError);
		$this->pagina->agregarDato("mensajeOK",$this->mensajeOK);
		// se imprime el template con la pagina
		$this->pagina->imprimirTemplate('templates/documentos_manuales_Listado.html');
	}
	...
	private function detalle(){ 
		...
		if ($estado == 1) //si debe cumplir con mas condiciones agregar
		{
			$formulario[0]["aprobar"][0]	= "";
		...
		$this->pagina->agregarDato("mensajeOK",$this->mensajeOK);
		// se imprime el template con la pagina
		$this->pagina->imprimirTemplate('templates/documentos_manuales_Detalle.html');
	}
	...
	public function verdocumento()
	{
        ...
        print_r($formulario);
		$this->pagina->agregarDato("formulario",$formulario);
		$this->estadocontratosBD->listado($dt2);
		$this->mensajeError.=$this->estadocontratosBD->mensajeError;
		$formulariox[0]["estadocontratos"] = $dt2->data;
