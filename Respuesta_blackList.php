...
class respuesta_importar_masivo{
	...
	// revisamos si la accion es volver desde el listado principal
		...
		$this->opcion = "Resultado ultima carga ";
		$this->opciondetalle = "";
		$this->opcionicono = "fa fa-cog";
		$this->opcionnivel1 = "MANTENEDORES";
		$this->opcionnivel2 = "<li>Resultado ultima carga</li>";
	...
	{  
		...
		$this->pagina->imprimirTemplate('templates/respuesta_blackList_Listado.html');
	}
	//Mostrar fin
