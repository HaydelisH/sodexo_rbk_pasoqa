...
class generar_fichapersonal {
	...
	function __construct()
	{
		...
		$this->opcion = "Declaraci&oacute;n de conflictos de inter&eacute;s clc-2022";
		$this->opciondetalle = "";
		$this->opcionicono = "fa fa-cog";
		$this->opcionnivel1 = "FORMULARIO";
		$this->opcionnivel2 = "<li>Declaraci&oacute;n de conflictos de inter&eacute;s clc-2022</li>";
    ...
    private function acceder()
    {
		...
		$data["personaid"]=$this->seguridad->usuarioid; 
		
		$this->empleadosBD->obtener($data,$dt);
		...
		$this->documentosBD->obtenerVariablesEmpresaConRutEmpresa($data,$dt);
        $this->mensajeError = $this->documentosBD->mensajeError;
		...
		$dat["opcionid"] = 'DeclaracionConflictoInteresclc-2022.php';
		...
		$this->pagina->imprimirTemplate('templates/DeclaracionConflictoInteresclc-2022.html');
	}
