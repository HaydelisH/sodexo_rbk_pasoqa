...
$page = new rl_flujosPorEnte();

class rl_flujosPorEnte {
	...
	{	
		...
		$formulario[0]["orden"][0]['idorden'] = 1;
		$formulario[0]["orden"][1]['idorden'] = 0;	
		$formulario[0]["orden"][0]['nombre'] = 'Si';
		$formulario[0]["orden"][1]['nombre'] = 'No';		
		...
		$this->pagina->imprimirTemplate('templates/rl_flujoPorEnte_FormularioAgregar.html');
	...
	{	
		...
		$this->pagina->imprimirTemplate('templates/rl_flujoPorEnte_FormularioModificar.html');
	...
	{  
		...
		$datos["opcionid"] = 'rl_flujosPorEnte.php';
		...
		$this->pagina->imprimirTemplate('templates/rl_flujoPorEnte_Listado.html');
