...
class jornadas {
	...
	{	
		...
		$this->pagina->imprimirTemplate('templates/jornadas_FormularioAgregar.html');
	}
	...
	{	
		...
		$this->pagina->imprimirTemplate('templates/jornadas_FormularioModificar.html');
	...
	{  
		...
		$this->pagina->imprimirTemplate('templates/jornadas_Listado.html');
	}
	//Mostrar fin
