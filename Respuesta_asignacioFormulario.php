...
class respuesta_importar_masivo{
	...
	// revisamos si la accion es volver desde el listado principal
		...
		$this->opcion = "Respuesta de asignaci&oacute;n de formulario ";
		$this->opciondetalle = "";
		$this->opcionicono = "fa fa-cog";
		$this->opcionnivel1 = "MANTENEDORES";
		$this->opcionnivel2 = "<li>Resultado asignaci&oacute;n formulario</li>";
	...
	{  
		...
		$this->respuesta_importarBD->listadoTotal($datos,$dt);
		$this->mensajeError.=$this->respuesta_importarBD->mensajeError;
		...
		$this->pagina->imprimirTemplate('templates/respuesta_asignacionFormulario_Listado.html');
	}
	//Mostrar fin
