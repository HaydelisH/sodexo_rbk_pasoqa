...
class respuesta_importar_masivo{
	...
	// revisamos si la accion es volver desde el listado principal
		...
		$this->opcion = "Respuesta de resultados de postulaci&oacute;n ";
		$this->opciondetalle = "";
		$this->opcionicono = "fa fa-cog";
		$this->opcionnivel1 = "MANTENEDORES";
		$this->opcionnivel2 = "<li>Resultado postulaci&oacute;n</li>";
	...
	{  
		...
		$this->pagina->imprimirTemplate('templates/respuesta_resultadoPostulacion_Listado.html');
	}
	//Mostrar fin
