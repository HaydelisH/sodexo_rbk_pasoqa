...
class docvigentes{
	...
	function __construct()
	{
		...
		$this->opcion = "Revisi&oacute;n Asignados";
		$this->opciondetalle = "";
		$this->opcionicono = "fa fa-cog";
		$this->opcionnivel1 = "MANTENEDORES";
		$this->opcionnivel2 = "<li>Revisi&oacute;n Asignados </li>";
	...
	{  
		...
		$this->formularioPlantillaBD->totalListadoAsignados($datos,$dt);
		...
		for ($i = 0; $i < count($formulario[0]["listado"]); $i++){
            switch ($formulario[0]["listado"][$i]['estadoFormularioid']){
                case 1:{
                    //$formulario[0]["listado"][$i]["estadoFormulario"] = 'Hola opcion 1: Cancelar';
                    $formulario[0]["listado"][$i]["estadoFormulario"] .= "<button class='btn btn-primary btn-sm detalle' type='button' name='accion' value='CANCELAR' onclick='cambioEstado({$formulario[0]['listado'][$i]['empleadoFormularioid']}, 8)' >Cancelar</button>";
                    break;
                }
                case 8:{
                    $formulario[0]["listado"][$i]["estadoFormulario"] = "Cancelado";
                    break;
                }
            }
        }
		...
		//Estados de gestion
		$this->formularioPlantillaBD->listado1($dt5);
		$this->mensajeError .= $this->formularioPlantillaBD->mensajeError;
		$formulario[0]["Formularios"] = $dt5->data;
		
		//Estados de gestion de formularios
		...
		//Estados de gestion de formularios
		$this->estadoFormularioBD->listadoWF($dt5);
		$this->mensajeError .= $this->estadoFormularioBD->mensajeError;
		$formulario[0]["EstadosGestionWF"] = $dt5->data;
		...
		$this->pagina->imprimirTemplate('templates/revisionAsignados_listado.html');
	}
	...
	private function detalle(){ 
        ...
        if ($dt5->data[0]['idEstadoGestion'] == 3) // Cerrado
        {
            $datos['actorid'] = 1;
            //var_dump($datos);
        ...
        */
        ...
        /*$this->estadoFormularioBD->obtener($datos, $dt2);
            ...
            $datos["opcionid"] = 'revisionAsignados.php';
		...
		// se imprime el template con la pagina
		$this->pagina->imprimirTemplate('templates/revisionAsignados_Detalle.html');
	}
    ...
    /*public function verdocumento()
	{
		...
		$this->pagina->agregarDato("mensajeError",$this->mensajeError);
		// se imprime el template con la pagina
		$this->pagina->imprimirTemplate('templates/revisionAsignados_Documento.html');				
    }*/
