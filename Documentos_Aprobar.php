...
class docvigentes{
	...
	{   
		...
		$this->docvigentesBD->listadoPorAprobar($datos,$dt);
		$this->mensajeError.=$this->docvigentesBD->mensajeError;
		...
		if ( $registros==0 ) 
		{
			$this->mensajeAd.="No hay documentos para aprobar.";
		...
		$datos["opcionid"] = 'Documentos_Aprobar.php';
		...
		$this->pagina->imprimirTemplate('templates/documentos_aprobar_Listado.html');
	}
