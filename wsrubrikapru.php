...
{	print_r($datosfirmantes);
	...
	*/
	...
	$respuestag = Cargar_Documento($usuario,$datosproceso,$datostrabajador,$datosdocumentos,$datosfirmantes);	
	$codigo    = $respuestag["codigo"];
	$mensaje   = $respuestag["mensaje"];
...
function Cargar_Documento($usuario,$datosproceso,$datostrabajador,$datosdocumentos,$datosfirmantes)
{	
