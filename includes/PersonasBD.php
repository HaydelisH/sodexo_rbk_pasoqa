...
class personasBD extends ObjetoBD //implements IOperacionesBD
{
	...
	function __construct()
	{
		...
		$this->definicion2["idFormulario"]=array("Tipo"=>"integer","Largo"=>"10","Key"=>"NO");
		...
		$this->definicion2["correoNotificacionPorConcentimiento"]=array("Tipo"=>"character","Largo"=>"","Key"=>"NO");
	}
