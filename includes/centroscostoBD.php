...
class centroscostoBD extends ObjetoBD //implements IOperacionesBD
{
	...
	function __construct()
	{
		...
		$this->definicion9["RL_LUGARPAGO_DEFECTO"]=array("Tipo"=>"character varying","Largo"=>"","Key"=>"YES");
		...
		$this->definicion14["idCentroCosto"]=array("Tipo"=>"character","Largo"=>"14","Key"=>"NO");
		$this->definicion14["nombreCentroCosto"]=array("Tipo"=>"character","Largo"=>"","Key"=>"NO");
		$this->definicion14["lugarpagoid"]=array("Tipo"=>"character","Largo"=>"14","Key"=>"NO");
		$this->definicion14["RutEmpresa"]=array("Tipo"=>"character varying","Largo"=>"10","Key"=>"YES");
		$this->definicion14["direccion"]=array("Tipo"=>"character varying","Largo"=>"10","Key"=>"YES");
		$this->definicion14["comuna"]=array("Tipo"=>"character varying","Largo"=>"10","Key"=>"YES");
		$this->definicion14["ciudad"]=array("Tipo"=>"character varying","Largo"=>"10","Key"=>"YES");
		
		$this->definicion15["pagina"]=array("Tipo"=>"integer","Largo"=>"","Key"=>"");
		$this->definicion15["decuantos"]=array("Tipo"=>"integer","Largo"=>"","Key"=>"");
		$this->definicion15["idCentroCosto"]=array("Tipo"=>"character","Largo"=>"14","Key"=>"NO");
		$this->definicion15["nombreCentroCosto"]=array("Tipo"=>"character","Largo"=>"","Key"=>"NO");
		$this->definicion15["lugarpagoid"]=array("Tipo"=>"character","Largo"=>"14","Key"=>"NO");
		$this->definicion15["nombrelugarpagoid"]=array("Tipo"=>"character","Largo"=>"","Key"=>"NO");
		$this->definicion15["RutEmpresa"]=array("Tipo"=>"character","Largo"=>"","Key"=>"NO");
	
		$this->definicion16["RutEmpresa"]=array("Tipo"=>"character varying","Largo"=>"","Key"=>"YES");
		$this->definicion16["lugarpagoid"]=array("Tipo"=>"character","Largo"=>"","Key"=>"NO");
	
		$this->definicion17["RutEmpresa"]=array("Tipo"=>"character varying","Largo"=>"14","Key"=>"YES");
		$this->definicion17["lugarpagoid"]=array("Tipo"=>"character","Largo"=>"","Key"=>"NO");
		$this->definicion17["idCentroCosto"]=array("Tipo"=>"character varying","Largo"=>"14","Key"=>"YES");
	}
	...
	public function agregar2($datos)
	{
		...
		// generar el SQL de obtencion registros
		$sql = "sp_centroscosto_agregar ".ContenedorUtilidades::generarLlamado2($datos,$this->definicion14);
	...
	public function modificar($datos)
	{
		...
		// generar el SQL de obtencion registros
		$sql = "sp_centroscosto_modificar ".ContenedorUtilidades::generarLlamado2($datos,$this->definicion14);
	...
	public function eliminar($datos)
	{
		...
		// generar el SQL de obtencion registros
		$sql = "sp_centroscosto_eliminar ".ContenedorUtilidades::generarLlamado2($datos,$this->definicion17);
	...
	public function listadoPaginado($datos,&$resultado)
	{
		...
		// generar el SQL de obtencion registros
		$sql = "sp_centroscosto_listadoPaginado ".ContenedorUtilidades::generarLlamado2($datos,$this->definicion15);
	...
	public function TotalPaginado($datos,&$resultado)
	{
		...
		// generar el SQL de obtencion registros
		$sql = "sp_centroscosto_totalPaginado ".ContenedorUtilidades::generarLlamado2($datos,$this->definicion15);
	...
	public function obtener2($datos,&$resultado)
	{
		// verificar los datos
		if (!ContenedorUtilidades::validarDatos($datos,$this->definicion17,$this->mensajeError,true)) return false;

		// generar el SQL de obtencion registros
		$sql = "sp_centroscosto_obtener2 ".ContenedorUtilidades::generarLlamado2($datos,$this->definicion17);
	...
	public function getCombo($datos,&$resultado)
	{
		...
		// generar el SQL de obtencion registros
		$sql = "sp_centroscosto_combo ".ContenedorUtilidades::generarLlamado2($datos,$this->definicion16);
