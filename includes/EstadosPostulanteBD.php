...
class EstadosPostulanteBD extends ObjetoBD //implements IOperacionesBD
{
	...
	public function obtenerTodo(&$resultado)
	{
		...
		$sql = "sp_EstadosPostulante_obtenerTodo ";//.ContenedorUtilidades::generarLlamado2($datos,$this->definicion);
