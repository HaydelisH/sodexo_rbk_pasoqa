...
class rl_tiposdocumentosBD extends ObjetoBD //implements IOperacionesBD
{
	...
	{
		// generar el SQL de obtencion registros
		$sql = "sp_rl_tiposdocumentos_listado ";
	...
	/*public function total($datos,&$resultado)
	{
		...
		// generar el SQL de obtencion registros
		$sql = "sp_tiposdocumentos_total ".ContenedorUtilidades::generarLlamado2($datos,$this->definicion5);
	...
	/*public function todosAgrupados($datos,&$resultado)
	{
		// verificar los datos
		if (!ContenedorUtilidades::validarDatos($datos,$this->definicion5,$this->mensajeError,true)) return false;

		// generar el SQL de obtencion registros
		$sql = "sp_tiposdocumentos_todos ".ContenedorUtilidades::generarLlamado2($datos,$this->definicion5);
	...
	public function TodosFlujoImp(&$resultado)
	{
		// generar el SQL de obtencion registros
		$sql = "sp_rl_tiposdocumentos_listado_exp ";
