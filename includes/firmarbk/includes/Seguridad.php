...
class Seguridad
{
	...
	private function verificarSesion()
	{
		...
		if ($dt->obtenerItem("cambiarclave")>0 && substr($_SERVER["PHP_SELF"],-16)!="cambio_clave.php") {

				header('Location: cambio_clave.php?mensajeError=Debe cambiar su clave para continuar');
				exit;
		}
