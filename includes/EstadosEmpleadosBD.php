...
class EstadosEmpleadosBD extends ObjetoBD //implements IOperacionesBD
{
	...
	public function obtener($datos,&$resultado)
	{
		...
		$sql = "sp_estadosempleados_obtener ".ContenedorUtilidades::generarLlamado2($datos,$this->definicion);
