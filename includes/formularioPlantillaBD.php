...
class formularioPlantillaBD extends ObjetoBD //implements IOperacionesBD
{
	...
	function __construct()
	{
		...
		$this->definicion17["pagina"]=array("Tipo"=>"integer","Largo"=>"","Key"=>"");
		$this->definicion17["decuantos"]=array("Tipo"=>"integer","Largo"=>"","Key"=>"");
        //$this->definicion17["idDocumento"]=array("Tipo"=>"integer","Largo"=>"","Key"=>"");
		$this->definicion17["RutEmpleado"]=array("Tipo"=>"character","Largo"=>"","Key"=>"");
		$this->definicion17["NombreEmpleado"]=array("Tipo"=>"character","Largo"=>"","Key"=>"");
		//$this->definicion17["fechaInicio"]=array("Tipo"=>"date","Largo"=>"","Key"=>"");
		//$this->definicion17["fechaFin"]=array("Tipo"=>"date","Largo"=>"","Key"=>"");
		$this->definicion17["idEstadoGestion"]=array("Tipo"=>"integer","Largo"=>"","Key"=>"");
		$this->definicion17["ptipousuarioid"]=array("Tipo"=>"integer","Largo"=>"","Key"=>"");
		$this->definicion17["usuarioid"]=array("Tipo"=>"character","Largo"=>"","Key"=>"");
		$this->definicion17["idFormulario"]=array("Tipo"=>"integer","Largo"=>"","Key"=>"");
		$this->definicion17["idEstadoFujoFirma"]=array("Tipo"=>"integer","Largo"=>"","Key"=>"");
		$this->definicion17["fechaCargaDesde"]=array("Tipo"=>"date","Largo"=>"","Key"=>"");
		$this->definicion17["fechaCargaHasta"]=array("Tipo"=>"date","Largo"=>"","Key"=>"");

		$this->definicion18["empleadoFormularioid"]=array("Tipo"=>"integer","Largo"=>"","Key"=>"");
		$this->definicion18["estadoFormularioid"]=array("Tipo"=>"integer","Largo"=>"","Key"=>"");
	}
	...
	{
		// generar el SQL de obtencion registros
		$sql = "sp_formularioPlantilla_listado1 ";//.ContenedorUtilidades::generarLlamado2($datos,$this->definicion14);
	...
	//Obtiene un conteo o tabla de registro
	public function totalListadoAsignados($datos,&$resultado)
	{
	 if (!ContenedorUtilidades::validarDatos($datos,$this->definicion17,$this->mensajeError,true)) return false;

		// generar el SQL de obtencion registros
		$sql = "sp_revisionListadoAsignados_total ".ContenedorUtilidades::generarLlamado2($datos,$this->definicion17);
	...
	//Obtener listado de clausulas Disponibles
	public function listadoAsignados($datos,&$resultado)
	{
		// generar el SQL de obtencion registros
        if (!ContenedorUtilidades::validarDatos($datos,$this->definicion17,$this->mensajeError,true)) return false;

		// generar el SQL de obtencion registros
		$sql = "sp_revisionListadoAsignados_obtener ".ContenedorUtilidades::generarLlamado2($datos,$this->definicion17);
	...
	public function cambioEstado($datos)
	{
		...
		// generar el SQL de obtencion registros
		$sql = "sp_empleadoFormulario_cambiarEstado ".ContenedorUtilidades::generarLlamado2($datos,$this->definicion18);
