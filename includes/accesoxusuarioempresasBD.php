...
class accesoxusuarioempresasBD extends ObjetoBD //implements IOperacionesBD
{
	...
	public function ListadoXperfil($datos,&$resultado)
	{
		...
		$sql = "sp_accesoxusuarioempresas_x_usuario ".ContenedorUtilidades::generarLlamado2($datos,$this->definicion1);
