...
class docvigentesBD extends ObjetoBD //implements IOperacionesBD
{
	...
	function __construct()
	{
		...
		$this->definicion9["RutEmpresa"]=array("Tipo"=>"character","Largo"=>"","Key"=>"");
		$this->definicion9["lugarpagoid"]=array("Tipo"=>"character","Largo"=>"","Key"=>"");
		$this->definicion9["idCentroCosto"]=array("Tipo"=>"character","Largo"=>"","Key"=>"");
		$this->definicion9["idPlantilla"]=array("Tipo"=>"character","Largo"=>"","Key"=>"");
		...
		$this->definicion12["RutEmpleado"]=array("Tipo"=>"character","Largo"=>"","Key"=>"");
		$this->definicion12["NombreEmpleado"]=array("Tipo"=>"character","Largo"=>"","Key"=>"");
		$this->definicion12["usuarioid"]=array("Tipo"=>"character","Largo"=>"50","Key"=>"");
		$this->definicion12["fichaid"]=array("Tipo"=>"integer","Largo"=>"","Key"=>"");
	
		$this->definicion13["ptipousuarioid"]=array("Tipo"=>"integer","Largo"=>"","Key"=>"");
		$this->definicion13["pagina"]=array("Tipo"=>"integer","Largo"=>"","Key"=>"");
		$this->definicion13["decuantos"]=array("Tipo"=>"integer","Largo"=>"","Key"=>"");
        $this->definicion13["idDocumento"]=array("Tipo"=>"integer","Largo"=>"","Key"=>"");
		$this->definicion13["idTipoDoc"]=array("Tipo"=>"integer","Largo"=>"","Key"=>"");
		$this->definicion13["idEstado"]=array("Tipo"=>"integer","Largo"=>"","Key"=>"");
		$this->definicion13["idTipoFirma"]=array("Tipo"=>"integer","Largo"=>"","Key"=>"");
		$this->definicion13["idProceso"]=array("Tipo"=>"integer","Largo"=>"","Key"=>"");
		$this->definicion13["Firmante"]=array("Tipo"=>"character","Largo"=>"","Key"=>"");
		$this->definicion13["usuarioid"]=array("Tipo"=>"character","Largo"=>"50","Key"=>"");
		$this->definicion13["RutEmpresa"]=array("Tipo"=>"character","Largo"=>"","Key"=>"");
		$this->definicion13["lugarpagoid"]=array("Tipo"=>"character","Largo"=>"","Key"=>"");
		$this->definicion13["idCentroCosto"]=array("Tipo"=>"character","Largo"=>"","Key"=>"");
		...
		$this->definicion16["idTipoDoc"]=array("Tipo"=>"integer","Largo"=>"","Key"=>"");
		$this->definicion16["idEstado"]=array("Tipo"=>"integer","Largo"=>"","Key"=>"");
		$this->definicion16["idTipoFirma"]=array("Tipo"=>"integer","Largo"=>"","Key"=>"");
		$this->definicion16["idProceso"]=array("Tipo"=>"integer","Largo"=>"","Key"=>"");
		$this->definicion16["Firmante"]=array("Tipo"=>"character","Largo"=>"","Key"=>"");
		$this->definicion16["usuarioid"]=array("Tipo"=>"character","Largo"=>"50","Key"=>"");
		$this->definicion16["fichaid"]=array("Tipo"=>"integer","Largo"=>"","Key"=>"");
		$this->definicion16["fechaInicio"]=array("Tipo"=>"date","Largo"=>"","Key"=>"");
		$this->definicion16["fechaFin"]=array("Tipo"=>"date","Largo"=>"","Key"=>"");
		$this->definicion16["RutEmpresa"]=array("Tipo"=>"character","Largo"=>"","Key"=>"");
		$this->definicion16["lugarpagoid"]=array("Tipo"=>"character","Largo"=>"","Key"=>"");
		$this->definicion16["idCentroCosto"]=array("Tipo"=>"character","Largo"=>"","Key"=>"");
		$this->definicion16["idPlantilla"]=array("Tipo"=>"integer","Largo"=>"","Key"=>"");
		$this->definicion16["rlTipoDocumento"]=array("Tipo"=>"character","Largo"=>"","Key"=>"");
		$this->definicion16["RutProveedor"]=array("Tipo"=>"character","Largo"=>"","Key"=>"");

		$this->definicion19["ptipousuarioid"]=array("Tipo"=>"integer","Largo"=>"","Key"=>"");
		$this->definicion19["pagina"]=array("Tipo"=>"integer","Largo"=>"","Key"=>"");
		$this->definicion19["decuantos"]=array("Tipo"=>"integer","Largo"=>"","Key"=>"");
        $this->definicion19["idDocumento"]=array("Tipo"=>"integer","Largo"=>"","Key"=>"");
		$this->definicion19["idTipoDoc"]=array("Tipo"=>"integer","Largo"=>"","Key"=>"");
		$this->definicion19["idEstado"]=array("Tipo"=>"integer","Largo"=>"","Key"=>"");
		$this->definicion19["idTipoFirma"]=array("Tipo"=>"integer","Largo"=>"","Key"=>"");
		$this->definicion19["idProceso"]=array("Tipo"=>"integer","Largo"=>"","Key"=>"");
		$this->definicion19["Firmante"]=array("Tipo"=>"character","Largo"=>"","Key"=>"");
		$this->definicion19["idPlantilla"]=array("Tipo"=>"integer","Largo"=>"","Key"=>"");
		$this->definicion19["nombreTrabajador"]=array("Tipo"=>"character","Largo"=>"","Key"=>"");
		$this->definicion19["rlTipoDocumento"]=array("Tipo"=>"character","Largo"=>"","Key"=>"");
		$this->definicion19["fechaInicio"]=array("Tipo"=>"date","Largo"=>"","Key"=>"");
		$this->definicion19["fechaFin"]=array("Tipo"=>"date","Largo"=>"","Key"=>"");
		
		$this->definicion20["ptipousuarioid"]=array("Tipo"=>"integer","Largo"=>"","Key"=>"");
		$this->definicion20["pagina"]=array("Tipo"=>"integer","Largo"=>"","Key"=>"");
		$this->definicion20["decuantos"]=array("Tipo"=>"integer","Largo"=>"","Key"=>"");
        $this->definicion20["idDocumento"]=array("Tipo"=>"integer","Largo"=>"","Key"=>"");
		$this->definicion20["idTipoDoc"]=array("Tipo"=>"integer","Largo"=>"","Key"=>"");
		$this->definicion20["idEstado"]=array("Tipo"=>"integer","Largo"=>"","Key"=>"");
		$this->definicion20["idTipoFirma"]=array("Tipo"=>"integer","Largo"=>"","Key"=>"");
		$this->definicion20["idProceso"]=array("Tipo"=>"integer","Largo"=>"","Key"=>"");
		$this->definicion20["Firmante"]=array("Tipo"=>"character","Largo"=>"","Key"=>"");
		$this->definicion20["usuarioid"]=array("Tipo"=>"character","Largo"=>"50","Key"=>"");
		$this->definicion20["fichaid"]=array("Tipo"=>"integer","Largo"=>"","Key"=>"");
		$this->definicion20["rlTipoDocumento"]=array("Tipo"=>"character","Largo"=>"","Key"=>"");
	...
	public function total_pp($datos,&$resultado)
	{
	 if (!ContenedorUtilidades::validarDatos($datos,$this->definicion13,$this->mensajeError,true)) return false;
		...
		// generar el SQL de obtencion registros
		$sql = "sp_documentosvigentes_total_porprocesos ".ContenedorUtilidades::generarLlamado2($datos,$this->definicion13);
	...
	public function listado_pp($datos,&$resultado)
	{
		...
		// generar el SQL de obtencion registros
		$sql = "sp_documentosvigentes_listado_porprocesos_2 ".ContenedorUtilidades::generarLlamado2($datos,$this->definicion13);
	...
	//Relacion laboral
	//Obtiene un conteo o tabla de registro
	public function rl_totalMisDocumentos($datos,&$resultado)
	{
	 if (!ContenedorUtilidades::validarDatos($datos,$this->definicion19,$this->mensajeError,true)) return false;

		// generar el SQL de obtencion registros
		$sql = "sp_rl_documentos_total_firmaunitaria ".ContenedorUtilidades::generarLlamado2($datos,$this->definicion19);
	...
	// relacion laboral
	//Obtener listado de clausulas Disponibles
	public function rl_listadoMisDocumentos($datos,&$resultado)
	{
		// generar el SQL de obtencion registros
        if (!ContenedorUtilidades::validarDatos($datos,$this->definicion19,$this->mensajeError,true)) return false;

		// generar el SQL de obtencion registros
		$sql = "sp_rl_documentos_listado_firmaunitaria ".ContenedorUtilidades::generarLlamado2($datos,$this->definicion19);
	...
	/*// Relacion laboral
	//Obtener listado de clausulas Disponibles
	public function rl_listadoPorTiempo($datos,&$resultado)
	{
		// generar el SQL de obtencion registros
        if (!ContenedorUtilidades::validarDatos($datos,$this->definicion9,$this->mensajeError,true)) return false;

		// generar el SQL de obtencion registros
		$sql = "sp_rl_documentosvigentes_listadoPorTiempo ".ContenedorUtilidades::generarLlamado2($datos,$this->definicion9);
	...
	//Relacion laboral
	//Obtiene un conteo o tabla de registro
	public function rl_totalPorTiempo($datos,&$resultado)
	{
	 if (!ContenedorUtilidades::validarDatos($datos,$this->definicion9,$this->mensajeError,true)) return false;

		// generar el SQL de obtencion registros
		$sql = "sp_rl_documentosvigentes_totalPorTiempo ".ContenedorUtilidades::generarLlamado2($datos,$this->definicion9);
	...
	// relacion laboral
	//Obtener listado de clausulas Disponibles
	public function rl_listadoPorEstructura($datos,&$resultado)
	{
		// generar el SQL de obtencion registros
        if (!ContenedorUtilidades::validarDatos($datos,$this->definicion16,$this->mensajeError,true)) return false;

		// generar el SQL de obtencion registros
		$sql = "sp_rl_documentosvigentes_listadoPorEstructura ".ContenedorUtilidades::generarLlamado2($datos,$this->definicion16);
	...
	// Relacion laboral
	//Obtiene un conteo o tabla de registro
	public function rl_totalPorEstructura($datos,&$resultado)
	{
	 if (!ContenedorUtilidades::validarDatos($datos,$this->definicion16,$this->mensajeError,true)) return false;

		// generar el SQL de obtencion registros
		$sql = "sp_rl_documentosvigentes_totalPorEstructura ".ContenedorUtilidades::generarLlamado2($datos,$this->definicion16);
	...
	// Relacion laboral
	//Obtiene un conteo o tabla de registro
	public function rl_totalPorAprobar($datos,&$resultado)
	{
	 if (!ContenedorUtilidades::validarDatos($datos,$this->definicion20,$this->mensajeError,true)) return false;

		// generar el SQL de obtencion registros
		$sql = "sp_rl_documentosporaprobar_total ".ContenedorUtilidades::generarLlamado2($datos,$this->definicion20);
	...
	// Relacion laboral
	//Obtener listado de clausulas Disponibles
	public function rl_listadoPorAprobar($datos,&$resultado)
	{
		// generar el SQL de obtencion registros
        if (!ContenedorUtilidades::validarDatos($datos,$this->definicion20,$this->mensajeError,true)) return false;

		// generar el SQL de obtencion registros
		$sql = "sp_rl_documentosporaprobar_listado ".ContenedorUtilidades::generarLlamado2($datos,$this->definicion20);
	...
	//Buscar solo el id de los documentos a aprobar
	public function rl_listadoSoloDocumentosPorAprobar($datos,&$resultado)
	{
		// generar el SQL de obtencion registros
        if (!ContenedorUtilidades::validarDatos($datos,$this->definicion20,$this->mensajeError,true)) return false;

		// generar el SQL de obtencion registros
		$sql = "sp_rl_documentosvigentes_soloidDocumentoPorAprobar ".ContenedorUtilidades::generarLlamado2($datos,$this->definicion20);
