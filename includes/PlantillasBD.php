...
class plantillasBD extends ObjetoBD //implements IOperacionesBD
{
	...
	function __construct()
	{
		...
		// Relacion Laboral
		$this->definicion20["RutEmpresa"]=array("Tipo"=>"character","Largo"=>"10","Key"=>"NO");
		$this->definicion20["idTipoDoc"]=array("Tipo"=>"integer","Largo"=>"","Key"=>"NO");
		$this->definicion20["idTipoFlujo"]=array("Tipo"=>"integer","Largo"=>"","Key"=>"NO");


		// Relacion Laboral
		$this->definicion21["Descripcion_Pl"]=array("Tipo"=>"character","Largo"=>"50","Key"=>"NO");
		$this->definicion21["Titulo_Pl"]=array("Tipo"=>"base64","Largo"=>"","Key"=>"NO");
		$this->definicion21["idWF"]=array("Tipo"=>"integer","Largo"=>"","Key"=>"NO");
		$this->definicion21["idTipoDoc"]=array("Tipo"=>"integer","Largo"=>"","Key"=>"NO");
		$this->definicion21["RutModificador"]=array("Tipo"=>"character","Largo"=>"10","Key"=>"NO");
		$this->definicion21["RutAprobador"]=array("Tipo"=>"character","Largo"=>"10","Key"=>"NO");
		$this->definicion21["idCategoria"]=array("Tipo"=>"integer","Largo"=>"","Key"=>"NO");
		$this->definicion21["idTipoGestor"]=array("Tipo"=>"integer","Largo"=>"","Key"=>"NO");
		$this->definicion21["RutEmpresa"]=array("Tipo"=>"character","Largo"=>"10","Key"=>"NO");

		
		$this->definicion23["idPlantilla"]=array("Tipo"=>"integer","Largo"=>"","Key"=>"NO");
		$this->definicion23["PREFIJO_VAR"]=array("Tipo"=>"character","Largo"=>"","Key"=>"NO");
		$this->definicion23["SUFIJO_VAR"]=array("Tipo"=>"character","Largo"=>"","Key"=>"NO");
		$this->definicion23["SEPARADOR"]=array("Tipo"=>"character","Largo"=>"","Key"=>"NO");
		$this->definicion23["VAR_FECHA_LARGA"]=array("Tipo"=>"character","Largo"=>"","Key"=>"NO");
		$this->definicion23["VAR_FECHA_CORTA"]=array("Tipo"=>"character","Largo"=>"","Key"=>"NO");
		$this->definicion23["VAR_FECHA_LARGA_ST"]=array("Tipo"=>"character","Largo"=>"","Key"=>"NO");
		$this->definicion23["VAR_FECHA_CORTA_ST"]=array("Tipo"=>"character","Largo"=>"","Key"=>"NO");
		$this->definicion23["VAR_FECHA_INDEFINIDA"]=array("Tipo"=>"character","Largo"=>"","Key"=>"NO");
		$this->definicion23["VAR_NUM_A_LETRAS_MAYUS"]=array("Tipo"=>"character","Largo"=>"","Key"=>"NO");
		$this->definicion23["VAR_NUM_A_LETRAS_MINUS"]=array("Tipo"=>"character","Largo"=>"","Key"=>"NO");
		$this->definicion23["VAR_NUM_A_LETRAS_MIXTO"]=array("Tipo"=>"character","Largo"=>"","Key"=>"NO");
		$this->definicion23["VAR_NUM_SEPARADOR_MILES"]=array("Tipo"=>"character","Largo"=>"","Key"=>"NO");
		$this->definicion23["VAR_VACIA"]=array("Tipo"=>"character","Largo"=>"","Key"=>"NO");
		$this->definicion23["SOLO"]=array("Tipo"=>"character","Largo"=>"","Key"=>"NO");
		
		
		$this->definicion70["tipoWF"]=array("Tipo"=>"integer","Largo"=>"","Key"=>"NO");
	}
	...
	// Relacion Laboral
	//Buscar plantilas por empresa, tipo de documento y por flujo
	public function obtenerPlantillasEmpresasTipoFlujo($datos,&$resultado)
	{
		// verificar los datos
		if (!ContenedorUtilidades::validarDatos($datos,$this->definicion20,$this->mensajeError,true)) return false;

		// generar el SQL de obtencion registros
		$sql = "sp_rl_plantillas_obtenerPlantillasEmpresasTipoFlujo ".ContenedorUtilidades::generarLlamado2($datos,$this->definicion20);
	...
	public function obtenerFlujos($datos, &$resultado)
	{
		// verificar los datos
		if (!ContenedorUtilidades::validarDatos($datos,$this->definicion70,$this->mensajeError,true)) return false;
		// generar el SQL de obtencion registros
		$sql = "sp_flujos_listado ".ContenedorUtilidades::generarLlamado2($datos,$this->definicion70);
...
////echo "<br/>".$sql."<br/>";
	...
	// Relacion Laboral
	// modificar un registro
	public function agregarexp($datos)
	{
		// verificar los datos
		if (!ContenedorUtilidades::validarDatos($datos,$this->definicion21,$this->mensajeError,true)) return false;

		// generar el SQL de obtencion registros
		$sql = "sp_rl_plantillasexp_agregar 'agregar' ".ContenedorUtilidades::generarLlamado($datos,$this->definicion21);
	...
	//Obtener listado de plantillas Disponibles
	public function listadoconempresas(&$resultado)
	{
		// generar el SQL de obtencion registros
		$sql = "sp_rl_plantillas_listado_con_empresas ";
	...
	public function getVariablesPlantilla($datos,&$resultado)
	{
		// verificar los datos
		if (!ContenedorUtilidades::validarDatos($datos,$this->definicion23,$this->mensajeError,true)) return false;

		// generar el SQL de obtencion registros
		$sql = "sp_getVariablesPlantilla ".ContenedorUtilidades::generarLlamado2($datos,$this->definicion23);
