...
class empleadosBD extends ObjetoBD //implements IOperacionesBD
{
	...
	function __construct()
	{
		...
		$this->definicion["correo"]=array("Tipo"=>"character","Largo"=>"60","Key"=>"NO");
		...
		$this->definicion["estadocivil"]=array("Tipo"=>"character","Largo"=>"20","Key"=>"NO");
		...
		$this->definicion2["idEstadoEmpleado"]=array("Tipo"=>"character","Largo"=>"100","Key"=>"NO");
