...
class ContratosDatosVariablesBD extends ObjetoBD //implements IOperacionesBD
{
	...
	function __construct()
	{
		...
		$this->definicion1["AplicaStrech1"]=array("Tipo"=>"character","Largo"=>"","Key"=>"NO");		
		$this->definicion1["AplicaStrech2"]=array("Tipo"=>"character","Largo"=>"","Key"=>"NO");		
		$this->definicion1["Stretch3"]=array("Tipo"=>"character","Largo"=>"","Key"=>"NO");		
		$this->definicion1["Stretch4"]=array("Tipo"=>"character","Largo"=>"","Key"=>"NO");		
		$this->definicion1["Booster"]=array("Tipo"=>"character","Largo"=>"","Key"=>"NO");		
		$this->definicion1["Modificador"]=array("Tipo"=>"character","Largo"=>"","Key"=>"NO");

		$this->definicion1["Texto6"]=array("Tipo"=>"character","Largo"=>"","Key"=>"NO");	
		$this->definicion1["Texto7"]=array("Tipo"=>"character","Largo"=>"","Key"=>"NO");	
