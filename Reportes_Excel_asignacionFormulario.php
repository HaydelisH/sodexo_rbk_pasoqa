...
class consultageneral_excel {
	...
	function __construct()
	{
		...
		$nombrearchivo = "Reportes_AsignacionFormulario_".$fechahoy;
		$this->pagina->iniciar($nombrearchivo,utf8_decode("Asignacion Formulario"));
