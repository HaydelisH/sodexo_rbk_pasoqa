...
class docvigentes{
	...
	function __construct()
	{
		...
		$this->opcion = "Revision RRHH  ";
		$this->opciondetalle = "";
		$this->opcionicono = "fa fa-cog";
		$this->opcionnivel1 = "MANTENEDORES";
		$this->opcionnivel2 = "<li>Revision RRHH </li>";
	...
	{  
		...
		$this->pagina->imprimirTemplate('templates/revisionActor1_listado.html');
	}
	...
	private function detalle(){ 
        ...
        */
		...
		// se imprime el template con la pagina
		$this->pagina->imprimirTemplate('templates/revisionActor1_Detalle.html');
	}
    ...
    public function verdocumento()
	{
		...
		$this->pagina->agregarDato("mensajeError",$this->mensajeError);
		// se imprime el template con la pagina
		$this->pagina->imprimirTemplate('templates/revisionActor1_Documento.html');				
    }
