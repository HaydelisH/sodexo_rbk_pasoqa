...
class consultageneral_excel {
	...
	function __construct()
	{
		...
		$nombrearchivo = "Reportes_DocumentosVigentes_".$fechahoy;
		...
		$this->docvigentesBD->rl_totalPorEstructura($datos,$dt1);
		...
		$descripciones = array(
				...
				//utf8_decode("Plantilla"),
				utf8_decode("nombreDocumento"),
				utf8_decode("Estado"),
				utf8_decode("Firma"),
				"FechaCreacion",
				"RutEmpresa",
				...
				utf8_decode("RazonSocial"),
				"Cliente",
				utf8_decode("NombreCliente"),
				"Unidad de Negocio",
				utf8_decode("Nombre de Unidad de Negocio")
			);

		$tipos = array("normal","normal","normal","normal","normal","normal","normal","normal","normal","normal","normal","normal","normal","normal","normal","normal","normal");

		$ancho = array("10","30","30","30","15","30","15","30","15","20","30","20","30","20","30","20","30");
