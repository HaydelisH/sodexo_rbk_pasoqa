...
class generar_fichapersonal {
	...
	{	
		...
		if(isset($datos["Firmantes_Emp"])){		
			...
			foreach($datos["Firmantes_Emp"] as &$valor){
				$x = "orden_".$valor;			
				array_push($datos["ordenfirmantes"],$datos[$x]);
			}			
			$datos["Firmantes_Emp"]= implode('|',$datos["Firmantes_Emp"]);		
			$datos["ordenfirmantes"]= implode('|',$datos["ordenfirmantes"]);		
		}
		
		$arrChino = array('%20','%C3%A1','%C3%A9','%C3%AD','%C3%B3','%C3%BA','%C3%81','%C3%89','%C3%8D','%C3%93','%C3%9A','%C3%91','%C3%B1','%40','%C2%B0','&amp;');
		$arrMandarin = array(' ','á','é','í','ó','ú','Á','É','Í','Ó','Ú','Ñ','ñ','@','°','&');
		$datos['nombre'] = utf8_decode(str_replace($arrChino, $arrMandarin, $datos['nombre']));
		$datos['appaterno'] = utf8_decode(str_replace($arrChino, $arrMandarin, $datos['appaterno']));
		$datos['apmaterno'] = utf8_decode(str_replace($arrChino, $arrMandarin, $datos['apmaterno']));
		$datos['nacionalidad'] = utf8_decode(str_replace($arrChino, $arrMandarin, $datos['nacionalidad']));
		$datos['direccion'] = utf8_decode(str_replace($arrChino, $arrMandarin, $datos['direccion']));
		$datos['comuna'] = utf8_decode(str_replace($arrChino, $arrMandarin, $datos['comuna']));
		$datos['ciudad'] = utf8_decode(str_replace($arrChino, $arrMandarin, $datos['ciudad']));
		$datos['nombrelugarpago'] = utf8_decode(str_replace($arrChino, $arrMandarin, $datos['nombrelugarpago']));
		$datos['nombrecentrocosto'] = utf8_decode(str_replace($arrChino, $arrMandarin, $datos['nombrecentrocosto']));
		$datos['RazonSocial'] = utf8_decode(str_replace($arrChino, $arrMandarin, $datos['RazonSocial']));
		...
		$this->subclausulasBD->listado($dt);
		$this->mensajeError.=$this->subclausulasBD->mensajeError;
		$formulario[0]["Jornadas"] = $dt->data;
	...
	private function generar(){
		...
		$arrChino = array('%20','%C3%A1','%C3%A9','%C3%AD','%C3%B3','%C3%BA','%C3%81','%C3%89','%C3%8D','%C3%93','%C3%9A','%C3%91','%C3%B1','%40','%C2%B0');
		$arrMandarin = array(' ','á','é','í','ó','ú','Á','É','Í','Ó','Ú','Ñ','ñ','@','°');
		$datos['nombre'] = str_replace($arrChino, $arrMandarin, $datos['nombre']);
		$datos['appaterno'] = str_replace($arrChino, $arrMandarin, $datos['appaterno']);
		$datos['apmaterno'] = str_replace($arrChino, $arrMandarin, $datos['apmaterno']);
		$datos['nacionalidad'] = str_replace($arrChino, $arrMandarin, $datos['nacionalidad']);
		$datos['direccion'] = str_replace($arrChino, $arrMandarin, $datos['direccion']);
		$datos['comuna'] = str_replace($arrChino, $arrMandarin, $datos['comuna']);
		$datos['ciudad'] = str_replace($arrChino, $arrMandarin, $datos['ciudad']);
		$datos['nombrelugarpago'] = utf8_decode(str_replace($arrChino, $arrMandarin, $datos['nombrelugarpago']));
		$datos['nombrecentrocosto'] = utf8_decode(str_replace($arrChino, $arrMandarin, $datos['nombrecentrocosto']));
		$datos['RazonSocial'] = utf8_decode(str_replace($arrChino, $arrMandarin, $datos['RazonSocial']));
		...
		//$respuesta = $generar->CompletarGeneracion($datos);
