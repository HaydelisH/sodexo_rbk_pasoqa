...
$page = new BuscarReportePostulacion();

class BuscarReportePostulacion{
	...
	{  
        ...
        $this->postulacionBD->listadoReporteTotal($datos,$dt);
        ...
        $this->postulacionBD->listadoReportePaginado($datos,$dt);
		$this->mensajeError.=$this->postulacionBD->mensajeError;
		...
		$this->pagina->agregarDato("autoFiltroPaginado", ContenedorUtilidades::autoFiltro('buscarReportePostulacion', $datos)['datos2datos']);
		// Filtro de busqueda y navegacion

		// se imprime el template con la pagina
		$this->pagina->imprimirTemplate('templates/buscarReportePostulacion.html');
	}
