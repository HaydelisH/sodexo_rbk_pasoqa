...
$page = new obtenerenrolado();

class obtenerenrolado {
	...
	function __construct()
	{
		...
		$this->opcion = "Obtener Enrolado";
		$this->opciondetalle = "";
		$this->opcionicono = "fa fa-cog";
		$this->opcionnivel1 = "MANTENEDORES";
		$this->opcionnivel2 = "<li>Obtener Enrolado</li>";
	...
	{	
		...
		$this->pagina->imprimirTemplate('templates/obtenerenrolado_Listado.html');	
	}
