...
class generar_fichapersonal {
	...
	function __construct()
	{
		...
		$this->opcion = "Declaracion Above Site ";
		$this->opciondetalle = "";
		$this->opcionicono = "fa fa-cog";
		$this->opcionnivel1 = "FORMULARIO";
		$this->opcionnivel2 = "<li>Declaracion Above Site</li>";
    ...
    private function acceder()
    {
		...
		$dat["opcionid"] = 'DeclaracionConflictoInteresAboveSite.php';
		...
		$this->pagina->imprimirTemplate('templates/DeclaracionConflictoInteresAboveSite.html');
	}
