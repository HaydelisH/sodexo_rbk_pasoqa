...
//Opcion del AJAX para laconsulta del documento en DEc luego de la firma con Token 
$page = new documentos();
...
class documentos {
	...
	function __construct()
	{
		...
		if( $this->mensajeError ){
			$this->graba_log('idDocumento : '.$datos["idDocumento"].'-Usuario: '.$datos['usuarioid'].'-Tipo de firma: Token - Error : '.$this->mensajeError);
			echo $this->mensajeError;
		}

		if( $this->mensajeOK ){	
			$this->graba_log('idDocumento : '.$datos["idDocumento"].'-Usuario: '.$datos['usuarioid'].'-Tipo de firma: Token - Ok : '.$this->mensajeOK);
			echo '0';
		}
