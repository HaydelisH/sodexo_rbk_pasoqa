...
class docvigentes{
	...
	function __construct()
	{
		...
		$this->opcion = "Documentos Aprobar";
		$this->opciondetalle = "";
		$this->opcionicono = "fa fa-cog";
		$this->opcionnivel1 = "MANTENEDORES";
		$this->opcionnivel2 = "<li>Documentos Aprobar</li>";
	...
	{   
		...
		$this->docvigentesBD->rl_totalPorAprobar($datos,$dt);
		$this->mensajeError.=$this->docvigentesBD->mensajeError;
		...
		$this->docvigentesBD->rl_listadoPorAprobar($datos,$dt);
		$this->mensajeError.=$this->docvigentesBD->mensajeError;
		...
		//$this->docvigentesBD->listadoPorTiposDocumentos_dv($datos_filtros,$dt);
		//$this->mensajeError.=$this->docvigentesBD->mensajeError;
		...
		//Listado de estados
		//$this->docvigentesBD->listadoPorEstados_dv($datos_filtros,$dt3);
		//$this->mensajeError.=$this->docvigentesBD->mensajeError;
		...
		//$this->docvigentesBD->listadoPorTipoFirmas_dv($datos_filtros,$dtfirmas);
		//$this->mensajeError.=$this->docvigentesBD->mensajeError;
		...
		//Listado de Procesos
		//$this->docvigentesBD->listadoPorProcesos_dv($datos_filtros,$dt4);
		//$this->mensajeError.=$this->docvigentesBD->mensajeError;
		...
		$datos["opcionid"] = 'rl_Documentos_Aprobar.php';
		...
		$this->pagina->imprimirTemplate('templates/rl_documentos_aprobar_Listado.html');
	}
