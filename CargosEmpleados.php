...
class cargosempleados {
	...
	{	
		...
		$this->pagina->imprimirTemplate('templates/cargosempleados_FormularioAgregar.html');
	}
	...
	{	
		...
		$this->pagina->imprimirTemplate('templates/cargosempleados_FormularioModificar.html');
	...
	{  
		...
		$this->pagina->imprimirTemplate('templates/cargosempleados_Listado.html');
	}
	//Mostrar fin
