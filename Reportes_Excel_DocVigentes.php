...
class consultageneral_excel {
	...
	function __construct()
	{
		...
		if( $datos["decuantos"] > 10000 )  $datos["decuantos"] = 27000;
		
		$this->graba_log($datos["decuantos"]."_".$this->mensajeError);
		...
		$descripciones = array(
				...
				utf8_decode("Proceso"),
				utf8_decode("Centro Costo"),
				utf8_decode("Nombre Centro Costo"),
				utf8_decode("Estado"),
				utf8_decode("Firma"),
				"FechaCreacion",
				"RutEmpresa",
				...
				"Correo",
				utf8_decode("Estado Trabajador"),
				utf8_decode("Observacion Rechazo")
			);

		$tipos = array("normal","normal","normal","normal","normal","normal","normal","normal","normal","normal","normal","normal","normal","normal","normal");

		$ancho = array("10","30","30","15","30","15","30","15","30","15","20","30","17","50","40");
