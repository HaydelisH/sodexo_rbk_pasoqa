...
class consultageneral_excel {
	...
	function __construct()
	{
		...
		$nombrearchivo = "Reportes_Generacion_Masiva_".$fechahoy;
		$this->pagina->iniciar($nombrearchivo,utf8_decode("Resultado de Generacion Masiva"));
		...
		$this->respuesta_importarBD->todos($datos,$dt);
