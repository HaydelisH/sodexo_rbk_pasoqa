...
class registrodec {
	...
	function __construct()
	{
		...
		$this->opcion = "Modificar Datos DEC";
		$this->opciondetalle = "";
		$this->opcionicono = "fa fa-user";
		$this->opcionnivel1 = "Modificar Datos DEC";
		$this->opcionnivel2 = "";
	...
	private function modificardatos()
	{
		...
		if (isset($_POST["accion2"]))
		{
			...
			$this->dec5->ModificarDatos($_POST,$dt);
		...
		$this->pagina->agregarDato("personaid",$_POST["usuarioid"]);

		$this->pagina->agregarDato("mensajeError",$this->mensajeError);
		$this->pagina->agregarDato("mensajeOK",$this->mensajeOK);
		// se imprime el formulario
		$this->pagina->imprimirTemplate('templates/cambiodatosdec_FormularioModificar.html');
