...
class obligaciones {
	...
	function __construct()
	{
		...
		$this->opcion = "Cargos de Empleados";
		$this->opciondetalle = "";
		$this->opcionicono = "fa fa-cog";
		$this->opcionnivel1 = "MANTENEDORES";
		$this->opcionnivel2 = "<li>Cargos de Empleados</li>";
	...
	{	
		...
		$this->pagina->imprimirTemplate('templates/obligaciones_FormularioAgregar.html');
	}
	...
	{	
		...
		$this->pagina->imprimirTemplate('templates/obligaciones_FormularioModificar.html');
	...
	{  
		...
		$datos["opcionid"] = 'obligaciones.php';
		...
		$this->pagina->imprimirTemplate('templates/obligaciones_Listado.html');
	}
	//Mostrar fin
