<?php
	...
	//***BASE DE DATOS***//
		...
		define ('SERVIDOR', 'rubrika-db-sqlserver.cspg4syes4w1.us-east-1.rds.amazonaws.com');
		//Nombre de la Base de Datos
		define ('BD', 'Sodexo_RBK');
		//Usuario de la Base de Datos
		define ('USUARIO', 'Sodexo');
		//Clave de Acceso de la Base de Datos
		define ('CLAVE', 'fdN3N6!o');	
	...
	//***VARIABLES***//
		...
		define('VAR_REPRESENTANTE_3', 'REPRESENTANTE3');
		...
		define('VAR_RUTA_COMPLETA','file:///C:/Aplicaciones/Sodexo_RBK/imagenes/');
	...
	//***VARIABLES DEL ARCHIVO DE CARGA***//
		...
		define('ORIGEN_DATA_VAR_DINAMICA', 'FechaInicio');// 'SERVIDOR');
	/*
	TIPO DE USUARIOS
	...
	*/
	...
	//***EMPLEADOS***//
		...
		define('ROL',2); // 1	Privado 2	General
	...
	define("ROLES_RBK_REPRESENTANTE_3", 'REPR3'); //Representante 3
...
//***Constantes de sistema***//
	...
	//***Ruta de generacion del PDF***//
		define('RUTA_GENERACION_ARCHIVO','C:\\Aplicaciones\\Sodexo_Rbk\\tmp\\');
	...
	/***Margenes del Spire***/
		define('TOP',80); // 2.5cm
		define('LEFT',90); // 3 cm
		define('RIGHT',70); // 3 cm
		define('BUTTON',60); // 2.5 cm
	...
	//Servicio split
		define('SERVICIO_SPLIT', 'http://localhost:7081/SplitPdf/Service.aspx');//servicio divide pdf
?>