...
class causales {
	...
	{	
		...
		$this->pagina->imprimirTemplate('templates/causales_FormularioAgregar.html');
	}
	...
	{	
		...
		$this->pagina->imprimirTemplate('templates/causales_FormularioModificar.html');
	...
	{  
		...
		$this->pagina->imprimirTemplate('templates/causales_Listado.html');
	}
	//Mostrar fin
